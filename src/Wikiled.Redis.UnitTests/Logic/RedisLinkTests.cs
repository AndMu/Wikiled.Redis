...
namespace Wikiled.Redis.UnitTests.Logic
{
    ...
    public class RedisLinkTests
    {
        ...
        public void Setup()
        {
            ...
            redisLink = new RedisLink(new NullLoggerFactory(), configuration, multiplexer.Object, Global.HandlingDefinitionFactory);
            redisLink.Open();
        }
        ...
        public void Create()
        {
            Assert.Throws<ArgumentNullException>(() => new RedisLink(new NullLoggerFactory(), configuration, null, Global.HandlingDefinitionFactory));
